# Description
After logging in, clicking the button will request user permission to retrieve geo-coordinates and IP info. </br>

<br />

For implementation <b>without</b> having to login, view -> [geolocation_ip_app](https://github.com/fceja/geolocation_ip_app/tree/main)
